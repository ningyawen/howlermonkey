...
# 生成输入文件名
inputfile_name <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/lossgenes/howlermonkey.geneloss.noOR.geneID.txt"
# 生成输出文件名
outputfile_name <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/lossgenes/Tissueenrichment.geneloss.noOR.geneID.txt"
outputfile_log10Pvalue <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/lossgenes/Tissueenrichment.geneloss.noOR.log10Pvalue.pdf"
outputfile_Foldchangebar <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/lossgenes/Tissueenrichment.geneloss.noOR.Foldchangebar.pdf"
...
# 使用 ggplot2 显示组织特异性基因的表达谱的热图
# 这里写一个循环，循环消化道组织
# Colon Rectum Pancreas Small Intestine Duodenum
...
for (tissue in vector_tissue) {
    ...
    outputfile_name <- paste0("/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/lossgenes/Tissueenrichment_TS_genes_expression_", tissue_name, ".txt")
    ...
    outputfile_enrichgenelist  <-  paste0("/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/lossgenes/Tissueenrichment_TS_enrichgeneID_", tissue_name, ".txt")
