...
# 生成输入文件名
# inputfile_name <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/reg/reg.geneID.txt"
inputfile_name <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/reg/reg.geneID.v2.txt"

# 生成输出文件名
outputfile_name <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/reg/Tissueenrichment_REG.txt"
outputfile_log10Pvalue <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/reg/Tissueenrichment_REG.log10Pvalue.pdf"
outputfile_Foldchangebar <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/reg/Tissueenrichment_REG.Foldchangebar.pdf"
...
for (tissue in vector_tissue) {
    ...
    outputfile_name <- paste0("/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/reg/Tissueenrichment_TS_genes_expression_", tissue_name, ".REG.txt")
    ...
    outputfile_enrichgenelist  <-  paste0("/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/reg/Tissueenrichment_TS_enrichgeneID_", tissue_name, ".REG.txt")
