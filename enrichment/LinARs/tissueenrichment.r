...
# 生成输入文件名
inputfile_name <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/LinARs/LinARs.geneID.txt"
# 生成输出文件名
outputfile_name <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/LinARs/Tissueenrichment_LinARs.txt"
outputfile_log10Pvalue <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/LinARs/Tissueenrichment_LinARs.log10Pvalue.pdf"
outputfile_Foldchangebar <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/LinARs/Tissueenrichment_LinARs.Foldchangebar.pdf"
...
for (tissue in vector_tissue) {
    ...
    outputfile_name <- paste0("/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/LinARs/Tissueenrichment_TS_genes_expression_", tissue_name, ".LinARs.txt")
    ...
    outputfile_enrichgenelist  <-  paste0("/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/LinARs/Tissueenrichment_TS_enrichgeneID_", tissue_name, ".LinARs.txt")
