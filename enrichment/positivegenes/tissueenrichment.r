...
# 生成输出文件名
outputfile_name <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/positivegenes/Tissueenrichment_PSG.txt"
outputfile_log10Pvalue <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/positivegenes/Tissueenrichment_PSG.log10Pvalue.pdf"
outputfile_Foldchangebar <- "/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/positivegenes/Tissueenrichment_PSG.Foldchangebar.pdf"
...
for (tissue in vector_tissue) {
    ...
    outputfile_name <- paste0("/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/positivegenes/Tissueenrichment_TS_genes_expression_", tissue_name, ".PSG.txt")
    ...
    outputfile_enrichgenelist  <-  paste0("/lustre/home/luyizheng/liunyw/project/howler_monkey/enrichment/positivegenes/Tissueenrichment_TS_enrichgeneID_", tissue_name, ".PSG.txt")
